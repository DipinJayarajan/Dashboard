  ...
  return (
    <div className='ml-3 h-screen md:overflow-hidden overflow-auto md:hover:overflow-auto pb-10'>
        ...
        <div className='flex justify-between items-center'>
            <Link to="/" onClick={handleCloseSidebar} className="items-center mt-4 gap-3 ml-3 flex text-xl font-extrabold tracking-tight dark:text-white text-slate-900">
            ...
            <TooltipComponent content="Menu" position="BottomCenter">
                ...
                className='text-xl roundedfull p-3 mt-4 hover:bg-light-gray block md:hidden' >
                    <MdOutlineCancel />
                </button>
            </TooltipComponent>
        </div>
